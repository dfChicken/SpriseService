...
public class OAuth2Callback extends HttpServlet {
    ...
    static String className = "service.gg.Oauth2callback";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String urlParameters = "code="
                    + code
                    + "&client_id=" + GGConnection.CLIENT_ID
                    + "&client_secret=" + GGConnection.CLIENT_SECRET
                    + "&redirect_uri=" + GGConnection.REDIRECT_URI
